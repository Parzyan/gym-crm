...
import com.company.gym_crm.facade.GymFacade;
...
public class GymCrmApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Trainee a = gymFacade.getTrainee(2L);
		Trainer b = gymFacade.getTrainer(2L);
		logger.info("Trainee with the id of 2: {}", a.getUsername());
		logger.info("Trainer with the id of 2: {}", b.getUsername());
